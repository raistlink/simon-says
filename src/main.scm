             ...
             (begin(if numberstate 
                   ...
                   (if (> statecounter round)
                       (begin (set! numberstate #f)
                              (set! computeraux (cdr computeraux))
                              (pp computeraux)
                              (set! statecounter 0)
                              (set! magictopleft #f)
                              (set! magictopright #f)
                   ...
                   (if (= (length playerinput) round)
                       (begin 
                         (pp (every = playerinput computeraux))
         ...
         (let* ((kevt (SDL_Event-key event))
           ...
           (cond ((= key SDLK_q)
                  (begin (set! magictopleft #f)
                         (set! playerinput (cons 0 playerinput))
                         (pp playerinput)))
                 ((= key SDLK_w)
                  (begin (set! magictopright #f)
                         (set! playerinput (cons 1 playerinput))
                         (pp playerinput)))
                 ((= key SDLK_a)
                  (begin (set! magicbottomleft #f)
                         (set! playerinput (cons 2 playerinput))
                         (pp playerinput)))
                 ((= key SDLK_s)
                  (begin (set! magicbottomright #f)
                         (set! playerinput (cons 3 playerinput))
                         (pp playerinput))))))
