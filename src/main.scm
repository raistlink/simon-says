     ...
     (lambda (cr)
       (case game-state
         ((start-screen)
          ...
          (if splashbackground
              (begin 
                ...
                (cairo_fill cr)
                (set! splashbackground #f)))
          (cairo_select_font_face cr "Sans" CAIRO_FONT_SLANT_NORMAL CAIRO_FONT_WEIGHT_BOLD)
          (cairo_set_source_rgba cr 1.0 1.0 0.0 0.01)
          (cairo_set_font_size cr 200.0)
          (cairo_move_to cr 250.0 250.0)
          (cairo_show_text cr "SIMON")
          (cairo_select_font_face cr "Sans" CAIRO_FONT_SLANT_NORMAL CAIRO_FONT_WEIGHT_BOLD)
          (cairo_set_source_rgba cr 1.0 1.0 0.0 0.01)
          (cairo_set_font_size cr 200.0)
          (cairo_move_to cr 350.0 650.0)
          (cairo_show_text cr "SAYS")
          (cairo_select_font_face cr "Sans" CAIRO_FONT_SLANT_NORMAL CAIRO_FONT_WEIGHT_BOLD)
          (cairo_set_source_rgba cr 1.0 1.0 0.0 0.01)
          (cairo_set_font_size cr 40.0)
          (cairo_move_to cr 500.0 400.0)
          (cairo_show_text cr "REVOLUTION")
          (cairo_select_font_face cr "Sans" CAIRO_FONT_SLANT_NORMAL CAIRO_FONT_WEIGHT_BOLD)
          (cairo_set_source_rgba cr 1.0 1.0 0.0 0.01)
          (cairo_set_font_size cr 30.0)
          (cairo_move_to cr 45.0 650.0)
         ...
         (else
          ...
          (cairo_fill cr)
          (when (eq? game-state 'success)
                (if (< count2 25)
                    (begin (set! count2 (+ count2 1))
                           (cairo_select_font_face cr "Sans" CAIRO_FONT_SLANT_NORMAL CAIRO_FONT_WEIGHT_BOLD)
                           (cairo_set_source_rgba cr 0.25 0.75 0.33 0.8)
                           (cairo_set_font_size cr 80.0)
                           (cairo_move_to cr 400.0 410.0)
                           (cairo_show_text cr "CORRECTO")
                           (cairo_fill cr))
                    (begin (set! count2 0)
